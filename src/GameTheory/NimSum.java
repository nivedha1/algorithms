...
//    boolean gameOver(int[] piles, int n) {
//        int i;
//        for (i = 0; i < n; i++)
//            if (piles[i] != 0)
//                return (false);
...
//    void makeMove(int piles[], int n, move moves) {
...
//            int[] non_zero_indices=new int[n];int count=0;
//
//            for (i = 0, count = 0; i < n; i++)
//                if (piles[i] > 0)
//                    non_zero_indices[count++] = i;
//
//            moves.pile_index = (Integer.parseInt(String.valueOf(Math.random())) % (count));
//            moves.stones_removed =
//                    1 + (Integer.parseInt(String.valueOf(Math.random())) % (piles[(moves).pile_index]));
...
//
//            if (whoseTurn == COMPUTER) {
//                System.out.println("COMPUTER removes %d stones from pile "+
//                         moves.stones_removed+
//                        moves.pile_index);
//                whoseTurn = HUMAN;
//            } else {
//                System.out.println("HUMAN removes %d stones from pile at "+ moves.stones_removed+
//                        moves.pile_index);
//                whoseTurn = COMPUTER;
//            }
//        }
...
//                                 int whoseTurn) {
//        System.out.println("Prediction before playing the game -> ");
//
